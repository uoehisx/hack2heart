...
export const ProfileSidebar = ({onContinue}:{onContinue:()=>void}) => {
  ...
  return (
    <div lang="en" style={{ minHeight: '100vh', width: '100vw', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'transparent', fontFamily: 'Inter, sans-serif' }}>
      <form style={{ width: 320, background: 'transparent', borderRadius: 16, padding: 24, boxShadow: '0 2px 8px #0001', display: 'flex', flexDirection: 'column', alignItems: 'center' }} acceptCharset="UTF-8" lang="en">
        <img src={profileImg} alt="profile" style={{ width: 96, height: 96, borderRadius: '50%', objectFit: 'cover', border: '2px solid #eee', marginBottom: 20 }} />
        <input
          type="text"
          value={name}
          onChange={e => setName(e.target.value)}
          placeholder="Enter your name"
          style={{ width: '80%', padding: 8, borderRadius: 6, border: '1px solid #ccc', marginBottom: 24, fontSize: 16, textAlign: 'center' }}
        />
        <div style={{ width: '100%', marginBottom: 16 }}>
          <div style={{ fontWeight: 600, fontSize: 16, marginBottom: 4 }}>Date of Birth</div>
          <input
            type="date"
            value={birth}
        ...
        <div style={{ width: '100%', marginBottom: 16 }}>
          <div style={{ fontWeight: 600, fontSize: 16, marginBottom: 4 }}>Gender</div>
        ...
        <div style={{ width: '100%', marginBottom: 24 }}>
          <div style={{ fontWeight: 600, fontSize: 16, marginBottom: 4 }}>Looking For</div>
          <div style={{ display: 'flex', gap: 12, justifyContent: 'center' }}>
            {lookingFor.map(l => (
